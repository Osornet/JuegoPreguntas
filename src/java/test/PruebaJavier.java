...
public class PruebaJavier {    
    ...
    public static void main(String[] args) {
        ...
        RespuestaDAOImp daores = new RespuestaDAOImp(); Respuesta r = new
        Respuesta(); Pregunta pregunta = new Pregunta(); pregunta.setId(1);
        r.setDescripcion("Respuesta correcta"); r.setCorrecta((byte)1);
